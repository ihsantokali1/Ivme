...
export default function CreateFlowForm({ onCreated }: CreateFlowFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await flowItemsApi.create(formData);
      setFormData({
        name: '',
        description: '',
      });
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 border-b-2 border-gray-200 dark:border-gray-700 pb-2">Yeni Akış Oluştur</h3>
